...
// MAKING VARIABLES FOR THE BUTTON
...
// ** ASK ABOUT **
  ...
  // Calls some of the pins we've attributed with it earlier
...
void initButtons() {
  ...
  btn_test.initButton(&tft, 260, 220, 60, 30, WHITE, ILI9341_DARKCYAN, WHITE, "Test", 2);
  // (array we made earlier, x value, y value, hight, width, border color, fill color, text color, text inside, text size)
}
...
void checkButtons() {
  ...
  // the little version of the touchscreen the computer holds has 
  // different x and y coordinates than the actual touchscreen
  // this function changes the x/y value the computer has and puts 
  // it into the x/y values of the real touchscreen
